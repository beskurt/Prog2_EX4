...
public class MovieListController implements Initializable {
    ...
    private SortingState sortingState = new NoneState();
    ...
    public void sortBtnClicked(ActionEvent actionEvent) {
        if (sortingState instanceof AscendingState) {
            sortingState = new DescendingState();
        } else if (sortingState instanceof DescendingState) {
            sortingState = new NoneState();
        } else {
